...
#include <esp_wifi.h> // Required for Long Range mode
...
void setup() {
  ...
  // 2. Disable Power Save Mode (CRITICAL for UDP Audio)
  // This prevents the WiFi radio from "napping," reducing jitter.
  WiFi.setSleep(false);

  // 3. Enable Long Range Mode (Optional/Experimental)
  // Note: This works best when communicating between two ESP32s. 
  // For a standard router, it helps the ESP32 "hear" better.
